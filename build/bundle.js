...
/******/ 		}
/******/ 		
/******/ 		var chunkLoadingGlobal = self["webpackChunkoutput"] = self["webpackChunkoutput"] || [];
...
const reasons = [
  "\u{1F9F1} Java is *absurdly* verbose.",
  "\u{1F4DC} Writing getters and setters feels like a punishment.",
  "\u{1F9D3} It was designed in 1995 and sometimes still feels like it.",
  "\u{1F4E6} `NullPointerException` \u2013 every Java dev's jump scare.",
  "\u{1F501} No good reason to need `public static void main` every time.",
  "\u{1F527} Dependency injection? More like dependency confusion.",
  "\u{1F6E0} XML configs. Enough said.",
  "\u{1F9EC} Generics: `<T extends Comparable<? super T>>` \u{1F635}",
  "\u{1F4BC} Java: The language of 'Enterprise Solutions\u2122'.",
  "\u{1F634} Boilerplate. Boilerplate everywhere."
];
const framesPerReason = 300;
function MyComposition() {
  const frame = (0,esm.useCurrentFrame)();
  return /* @__PURE__ */ (0,jsx_runtime.jsxs)(esm.AbsoluteFill, { className: "bg-white text-black flex items-center justify-center", children: [
    /* @__PURE__ */ (0,jsx_runtime.jsx)(esm.Sequence, { from: 0, durationInFrames: 90, children: /* @__PURE__ */ (0,jsx_runtime.jsxs)("div", { className: "text-center p-20", children: [
      /* @__PURE__ */ (0,jsx_runtime.jsx)(
        "h1",
        {
          className: "text-6xl font-bold mb-4",
          style: {
            opacity: (0,esm.interpolate)(frame, [0, 30], [0, 1], {
              extrapolateRight: "clamp"
            })
          },
          children: "Why Java is the Worst Language Ever*"
        }
      ),
      /* @__PURE__ */ (0,jsx_runtime.jsx)("p", { className: "text-xl text-gray-600", children: "*Don\u2019t take this too seriously \u{1F605}" })
    ] }) }),
    reasons.map((reason, index) => /* @__PURE__ */ (0,jsx_runtime.jsx)(
      esm.Sequence,
      {
        from: 90 + index * framesPerReason,
        durationInFrames: framesPerReason,
        children: /* @__PURE__ */ (0,jsx_runtime.jsx)("div", { className: "text-center p-20", children: /* @__PURE__ */ (0,jsx_runtime.jsx)(
          "h2",
          {
    ...
    /* @__PURE__ */ (0,jsx_runtime.jsx)(esm.Sequence, { from: 3090, durationInFrames: 510, children: /* @__PURE__ */ (0,jsx_runtime.jsxs)("div", { className: "text-center p-20", children: [
      /* @__PURE__ */ (0,jsx_runtime.jsx)("h2", { className: "text-5xl font-bold text-red-600 mb-4", children: "In Conclusion:" }),
      /* @__PURE__ */ (0,jsx_runtime.jsxs)("p", { className: "text-3xl max-w-3xl", children: [
        "Java isn\u2019t ",
        /* @__PURE__ */ (0,jsx_runtime.jsx)("em", { children: "that" }),
        " bad\u2026 but we all deserve less boilerplate."
      ] })
    ] }) })
  ] });
}
...
var renderContent = (Root) => {
  ...
  if (bundleMode.type === "index") {
    ...
    __webpack_require__.e(/* import() */ 652).then(__webpack_require__.bind(__webpack_require__, 7652)).then(({ StudioInternals }) => {
